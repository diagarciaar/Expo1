...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { Codigo: @asignatura.Codigo, Horarios: @asignatura.Horarios, name: @asignatura.name } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { Codigo: @asignatura.Codigo, Horarios: @asignatura.Horarios, name: @asignatura.name } }
