...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { Codigo: @profesor.Codigo, name: @profesor.name } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { Codigo: @profesor.Codigo, name: @profesor.name } }
