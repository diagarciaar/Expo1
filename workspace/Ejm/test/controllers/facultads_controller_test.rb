...
class FacultadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facultad" do
    assert_difference('Facultad.count') do
      post facultads_url, params: { facultad: { Nombreplanes: @facultad.Nombreplanes, name: @facultad.name } }
    end
  ...
  test "should update facultad" do
    patch facultad_url(@facultad), params: { facultad: { Nombreplanes: @facultad.Nombreplanes, name: @facultad.name } }
